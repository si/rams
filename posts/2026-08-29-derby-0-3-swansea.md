# Draft: Derby County 0-3 Swansea City
...
```
Derby 0-3 Swansea: "unacceptable," says Eustace, and for once he's not wrong
```

## Public preview (above the paywall)

```
No Szmodics, no answer. Derby's talisman was already ruled out for a fortnight
with a thigh injury, and without him this had the shape of a difficult afternoon
long before Joseph Opoku opened the scoring inside two minutes. Eom Ji-sung
doubled it right on half-time, Ronald added a third deep into stoppage time, and
John Eustace didn't dress any of it up afterwards — "unacceptable," he called it.
Cards, subs and the full breakdown for patrons below 👇
```
...
Derby County 0-3 Swansea City — Championship
...
John Eustace
"Unacceptable... we are lacking in confidence at the moment so conceding that
first goal so early on didn't help... to then concede the second just before
half-time was a kick in the teeth." No hiding afterwards, which is at least
something — but three home league games into the season and still no first
win is exactly the kind of start that turns a "buzz about the place" into a
crisis, fast.

Dion Sanderson
Booked at 79' for what's described as a bad foul — the kind of afternoon
where you can tell a defence is rattled by how it starts fouling out of
panic rather than positioning.

Sondre Langås
Booked at 69', same theme. Two minutes gone and Derby were already chasing
...
by the network egress proxy and everything above came from search-result
snippets instead of primary-source pages.
